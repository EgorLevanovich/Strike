...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_FloatingText : MMF_Feedback
	{
		...
		[SerializeField] private bool _useIntegersOnly = false;
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (UseIntensityAsValue)
			{
				_value = _useIntegersOnly ? 
					MMObjectPooler.Instance.GetCachedNumber(feedbacksIntensity) : 
					feedbacksIntensity.ToString();
			}
			else
			{
				_value = Value;
